...
The visualization below shows red pixels which indicate significant vegetation loss, with the condition of `clumps=TRUE`. This visualization was created using the layout function of ArcMap version 10.3.
